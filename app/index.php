                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="small-box bg-aqua">
                                        <div class="inner">
                                            <h4 style="font-size:17px;">
                                                <strong>GTQ <?php echo $totalc; ?></strong>
                                            </h4>
                                            <p>Compras</p>
                                        </div>
                                        <div class="icon">
                                        ...
                                        <a href="app/purchases" class="small-box-footer">Compras <i
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="small-box bg-green">
                                        <div class="inner">
                                            <h4 style="font-size:17px;">
                                                <strong>GTQ <?php echo $totalv; ?></strong>
                                            </h4>
                                            <p>Ventas</p>
                                        </div>
                                        <div class="icon">
                                        ...
                                        <a href="app/sales/" class="small-box-footer">Ventas <i
                                                class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        var compras = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Compras en GTQ de los últimos 10 días',
        ...
        var ventas = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Ventas en GTQ de los últimos 12 Meses',
